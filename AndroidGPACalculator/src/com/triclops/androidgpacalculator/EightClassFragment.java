...
public class EightClassFragment extends Fragment {
	
	private Spinner class1Spin, class2Spin, class3Spin, class4Spin, class5Spin, class6Spin, class7Spin, class8Spin;
	private TextView gpaLabel;
	private Button calcButton;
	
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View fragView = inflater.inflate(R.layout.eightclass_fragment, container, false);
